...
let isTTSActive = true; // TTS initially ON
...
function toggleTTS() {
  ...
  const ttsButton = document.querySelector('.tts-toggle');
  if (isTTSActive) {
    ttsButton.classList.add('active');
    showBotMessage('Text-to-Speech is ON. I will read out my messages!');
  } else {
    ttsButton.classList.remove('active');
    showBotMessage('Text-to-Speech is OFF. I won\'t read out my messages.');
  }
}
